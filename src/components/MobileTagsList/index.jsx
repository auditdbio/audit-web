...
const MobileTagsList = ({data}) => {
    ...
    return (
        <>
            <Box ref={containerRef} sx={{height: showMore ? "100%" : "150px", overflow: 'hidden'}}>
            ...
            {showButton && (
                <Button onClick={handleShowMore} color={currentRole === AUDITOR ? 'secondary' : 'primary'} sx={showMoreSx}>
